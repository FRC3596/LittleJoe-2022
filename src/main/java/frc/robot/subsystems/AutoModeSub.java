...
public class AutoModeSub extends Subsystem {
    ...
    public void Run() {
        ...
        Delay.MotorSpeed(4, 1, 0); // Deactivate shoot for 1 second - 1 second
        Delay.BotSpeed(2, -0.4); // Activate drive for 2 seconds at max speed - 2 seconds
        Delay.BotSpeed(3, 0); // Deactivate drive - 4 seconds
    }
}
